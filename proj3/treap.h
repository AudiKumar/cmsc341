...
private:
  ...
  void updateHeight();
  void rotateUp(TreapNode* parent, TreapNode* child, bool isRight);
  ...
  void roatateLeft(TreapNode* parent, TreapNode* rightChild);
  TreapNode* findW(TreapNode* y); //finds right's left most, or the left's rightmost
